...
def test_signature_request_send(container_bin,sdk_language,uploads_dir,auth_type,auth_key,server):
    ...
    response = helpers_hsapi.run(signatureRequestSend_data,container_bin,sdk_language,uploads_dir,auth_type,auth_key,server)
...
def test_signature_request_create_embedded(container_bin,sdk_language,uploads_dir,auth_type,auth_key,server):
        ...
        response = helpers_hsapi.run(signatureRequestCreateEmbedded_data, container_bin, sdk_language, uploads_dir, auth_type, auth_key, server)
